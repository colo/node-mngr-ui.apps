...
module.exports = new Class({
  ...
  render: function(req, res, next){
		if(!req.isAuthenticated()){
			...
			view.body_scripts.push('/public/apps/os/dashboard.js');
			
				
			res.render(path.join(__dirname, '/assets/dashboard'), view);
  ...
  initialize: function(options){
		this.profile('os_dashboard_init');//start profiling
		...
		this.profile('os_dashboard_init');//end profiling
		
		this.log('os_dashboard', 'info', 'os_dashboard started');
  },
